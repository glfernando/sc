...
constexpr time_ns_t operator""ns(unsigned long long t_ns) { return time_ns_t(t_ns); }

constexpr time_us_t operator""us(unsigned long long t_us) { return time_us_t(t_us); }

constexpr time_ms_t operator""ms(unsigned long long t_ms) { return time_ms_t(t_ms); }

constexpr time_s_t operator""s(unsigned long long t) { return time_s_t(t); }

constexpr time_min_t operator""min(unsigned long long t) { return time_min_t(t); }

constexpr time_h_t operator""h(unsigned long long t) { return time_h_t(t); }
